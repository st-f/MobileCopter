package shallowwater
{
	...
	public class ShallowFluid
	{
		...
		[Embed("/assets/embeds/pb/WaveDisplacement.pbj", mimeType="application/octet-stream")]
		private var DisplacementShaderClass:Class;
		private var _displacementShader:Shader;

		[Embed("/assets/embeds/pb/WaveNormals.pbj", mimeType="application/octet-stream")]
		private var NormalsShaderClass:Class;
		private var _normalsShader:Shader;

		[Embed("/assets/embeds/pb/WaveTangents.pbj", mimeType="application/octet-stream")]
